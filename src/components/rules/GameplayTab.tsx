          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-r from-trinity-blue-50 to-trinity-purple-50 rounded-2xl p-6 border-2 border-trinity-blue-200">
              ...
              <div className="space-y-4">
                <div className="glass-surface rounded-xl p-4 border-l-4 border-trinity-blue-500">
                ...
                <div className="glass-surface rounded-xl p-4 border-l-4 border-trinity-purple-500">
                ...
                <div className="glass-surface rounded-xl p-4 border-l-4 border-trinity-orange-500">
