      ...
      >
        <div className="text-center mb-6">
          <div className="flex justify-center mb-3">
            <div className="bg-dutch-purple text-white w-14 h-14 rounded-full flex items-center justify-center">
        ...
        <div className="mb-6">
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-xl p-3 space-y-2">
            {sortedPlayers.map((player, index) => (
              <div
                key={player.id}
                className={`flex justify-between items-center p-2 rounded-lg ${index === 0 ? 'bg-dutch-purple/10' : 'bg-white'}`}
              >
