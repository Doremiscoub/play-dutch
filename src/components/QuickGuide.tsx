...
const QuickGuide = () => {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-md rounded-3xl glass-surface border border-white/40 shadow-xl">
        <DialogHeader>
        ...
        <Tabs defaultValue="basics" className="mt-2">
          <TabsList className="grid w-full grid-cols-3 glass-surface rounded-full">
