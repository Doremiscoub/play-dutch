...
const EnhancedPlayerCard: React.FC<EnhancedPlayerCardProps> = ({
  ...
  const average = player.rounds.length > 0 ? Math.round(player.totalScore / player.rounds.length * 10) / 10 : 0;
  ...
  return <motion.div className={cn("relative rounded-3xl cursor-pointer group", "bg-gradient-to-br from-white/95 via-white/90 to-white/85", "backdrop-blur-xl border border-white/40 shadow-2xl", "transition-all duration-300 ease-out", isSelected || isExpanded ? "scale-[1.02] shadow-trinity border-trinity-blue-400/50 ring-2 ring-trinity-blue-500/30" : "hover:scale-[1.01] hover:shadow-trinity-lg hover:border-white/60")} onClick={handleCardClick} initial={{
    opacity: 0,
    y: 20
  }} animate={{
    opacity: 1,
    ...
    y: -3
      ...
      <div className="relative z-10 p-6 pt-10">
          ...
          <div className="flex items-center gap-4 flex-1">
            ...
            stiffness: 300
              ...
              >
                ...
                <motion.div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent -skew-x-12" animate={{
                x: ['-100%', '200%']
              }} transition={{
                duration: 3,
                repeat: Infinity,
        ...
        <motion.div className="flex flex-wrap gap-3 mb-6" initial={{
        opacity: 0,
        y: 20
      }} animate={{
        opacity: 1,
        ...
        delay: rank * 0.1 + 0.4
          ...
          <motion.div className="flex items-center gap-2 bg-gradient-to-r from-trinity-blue-100/80 via-trinity-blue-50/80 to-white/80 backdrop-blur-sm px-4 py-2 rounded-2xl border border-trinity-blue-200/60 shadow-lg" whileHover={{
          scale: 1.05,
          y: -2
        }} transition={{
          type: "spring",
          ...
          <motion.div className="bg-gradient-to-r from-green-100/80 via-emerald-50/80 to-white/80 backdrop-blur-sm px-4 py-2 rounded-2xl border border-green-200/60 shadow-lg" whileHover={{
          scale: 1.05,
          y: -2
        }} transition={{
          type: "spring",
          ...
          {dutchCount > 0 && <motion.div className="flex items-center gap-2 bg-gradient-to-r from-orange-100/80 via-yellow-50/80 to-white/80 backdrop-blur-sm px-4 py-2 rounded-2xl border border-orange-200/60 shadow-lg" whileHover={{
          scale: 1.05,
          y: -2
        }} animate={{
        ...
        {player.rounds.length > 0 && <motion.div className="relative mb-6" initial={{
        opacity: 0,
        scale: 0.9
      }} animate={{
        opacity: 1,
        ...
        delay: rank * 0.1 + 0.6
            ...
            <div className="flex justify-between items-center mb-3">
              ...
              <motion.span className="text-sm font-black text-gray-800 bg-white/80 backdrop-blur-sm px-3 py-1 rounded-full border border-gray-200/60 shadow-sm" animate={{
            scale: [1, 1.05, 1]
          }} transition={{
            duration: 2,
            repeat: Infinity
            ...
            <div className="relative h-3 bg-gradient-to-r from-gray-100/80 to-gray-200/80 backdrop-blur-sm rounded-full overflow-hidden shadow-inner border border-gray-300/40">
              <motion.div className={cn("h-full rounded-full shadow-lg relative overflow-hidden", "bg-gradient-to-r", player.totalScore / scoreLimit < 0.3 && "from-green-400 via-emerald-500 to-green-600", player.totalScore / scoreLimit >= 0.3 && player.totalScore / scoreLimit < 0.7 && "from-yellow-400 via-orange-400 to-orange-500", player.totalScore / scoreLimit >= 0.7 && "from-orange-500 via-red-500 to-red-600")} initial={{
            width: 0
          }} animate={{
            width: `${Math.min(100, player.totalScore / scoreLimit * 100)}%`
          }} transition={{
            duration: 2,
            ease: "easeOut",
            delay: 0.8
            ...
            repeat: Infinity
                ...
                {player.totalScore / scoreLimit < 0.3 ? '😎' : player.totalScore / scoreLimit < 0.7 ? '😅' : '😰'}
              </motion.span>
            </div>
          </motion.div>}
        ...
        <div className="flex justify-center">
          <motion.button className="group flex items-center gap-3 bg-gradient-to-r from-white/80 via-trinity-blue-50/60 to-trinity-purple-50/60 backdrop-blur-xl px-6 py-3 rounded-2xl border border-white/60 shadow-lg hover:shadow-xl transition-all relative overflow-hidden" whileHover={{
          scale: 1.05,
          y: -2
        }} whileTap={{
          scale: 0.95
          ...
          delay: rank * 0.1 + 0.8
            ...
            <motion.div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -skew-x-12 opacity-0 group-hover:opacity-100" animate={{
            x: ['-100%', '200%']
          }} transition={{
            duration: 0.6,
            ease: "easeInOut"
        ...
        <AnimatePresence>
          ...
          ease: "easeInOut"
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <motion.div className="bg-gradient-to-br from-green-100/90 via-emerald-50/80 to-white/80 backdrop-blur-sm rounded-2xl p-5 text-center border border-green-200/60 shadow-lg relative overflow-hidden" initial={{
              opacity: 0,
              scale: 0.8,
              rotateY: -30
            }} animate={{
              ...
              y: -3
                  ...
                  <motion.div className="absolute top-2 right-2 text-xl" animate={{
                scale: [1, 1.2, 1],
                rotate: [0, 360]
              }} transition={{
                duration: 3,
                ...
                <motion.div className="bg-gradient-to-br from-red-100/90 via-pink-50/80 to-white/80 backdrop-blur-sm rounded-2xl p-5 text-center border border-red-200/60 shadow-lg relative overflow-hidden" initial={{
              opacity: 0,
              scale: 0.8,
              rotateY: 30
            }} animate={{
              ...
              {player.rounds.length > 0 && <motion.div className="bg-gradient-to-br from-white/70 via-trinity-blue-50/50 to-trinity-purple-50/50 backdrop-blur-xl rounded-2xl p-5 border border-white/60 shadow-lg" initial={{
            opacity: 0,
            y: 20
          }} animate={{
            opacity: 1,
            ...
            delay: 0.3
                  ...
                  <div className="flex gap-2 flex-wrap">
                    {player.rounds.slice(-8).map((round, index) => <motion.div key={index} className={cn("relative px-4 py-3 rounded-xl text-sm font-black min-w-[50px] text-center backdrop-blur-sm border shadow-lg cursor-pointer group", round.score <= 10 && "bg-gradient-to-br from-green-100/90 to-emerald-100/80 text-green-700 border-green-300/60", round.score > 10 && round.score <= 20 && "bg-gradient-to-br from-yellow-100/90 to-orange-100/80 text-orange-700 border-orange-300/60", round.score > 20 && "bg-gradient-to-br from-red-100/90 to-pink-100/80 text-red-700 border-red-300/60", round.isDutch && "ring-2 ring-yellow-400 shadow-yellow-400/50")} initial={{
                opacity: 0,
                scale: 0.8,
                y: 10
              }} animate={{
                ...
                rotateZ: Math.random() * 10 - 5
                        ...
                        <div className="relative z-10">
                          {round.score}
                          {round.isDutch && <motion.div className="text-xs text-yellow-600 font-black" animate={{
                    scale: [1, 1.2, 1],
                    rotate: [0, 360]
                  }} transition={{
                    duration: 2,
