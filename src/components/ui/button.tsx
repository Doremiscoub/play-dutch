  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        "ios-outline": "border border-ios-gray/30 bg-white/90 text-ios-blue hover:bg-ios-light-gray/30 rounded-xl shadow-sm",
        ...
        "dutch-outline": "border border-gray-300 bg-white/90 text-dutch-blue hover:bg-gray-100/70 rounded-xl shadow-sm",
        "dutch-glass": "bg-white/80 backdrop-blur-sm border border-white/40 text-gray-700 hover:bg-white/90 rounded-xl shadow-sm",
        ...
        "pill-glass": "bg-white/70 backdrop-blur-sm border border-white/40 text-gray-700 hover:bg-white/80 rounded-full shadow-md",
        ...
        "game-control": "bg-white/80 backdrop-blur-sm border border-white/40 text-dutch-blue hover:bg-white/90 rounded-full shadow-md transition-all",
        "game-card": "bg-white/90 backdrop-blur-md border border-white/40 hover:shadow-lg transition-all duration-300 rounded-2xl shadow-sm hover:bg-white/95",
      },
      size: {
      ...
      glassmorphism: {
        true: "backdrop-blur-md bg-white/30 border border-white/40",
        false: "",
      },
      elevated: {
